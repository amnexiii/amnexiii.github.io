...
- El **"todo"**, para entender el para qué. Si no conoces todo lo que tienes sobre la mesa, ¿cómo vas a priorizar el siguiente paso? Claro que tendrás en la cabeza —o mejor, en algún backlog— la prioridad actual entre tus "épicas". Pero ¿y si recibes un mensaje que precisamente te invita a ejecutar un paso clave relativo a tu actual prioridad nº1? ¿O que te invita a pivotar algún aspecto clave sobre dicha prioridad? En menor medida, también puede ocurrir esto: ¿qué pasa si recibes un mensaje que te pide a gritos modificar el rumbo, llevándote a cambiar tu actual prioridad por otra diferente? La única manera es ser consciente de todo lo que te llega).
